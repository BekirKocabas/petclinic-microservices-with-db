...
resource "aws_instance" "kube-master" {
    ...
    key_name = "clarus"
    subnet_id = "subnet-00d463677a0379ef7"  # select own subnet_id of us-east-1a
...
resource "aws_instance" "worker-1" {
    ...
    key_name = "clarus"
    subnet_id = "subnet-02dc86e75cdd99568"  # select own subnet_id of us-east-1a
    availability_zone = "us-east-1a"
    tags = {
        Name = "worker-1"
        Project = "tera-kube-ans"
...
resource "aws_instance" "worker-2" {
    ...
    vpc_security_group_ids = [aws_security_group.petclinic-kube-worker-sg.id, aws_security_group.petclinic-mutual-sg.id]
    key_name = "clarus"
    subnet_id = "subnet-0af385b3830abae07"  # select own subnet_id of us-east-1a
    availability_zone = "us-east-1a"
    tags = {
        Name = "worker-2"
        Project = "tera-kube-ans"
